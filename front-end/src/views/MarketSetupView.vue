...
const settingsBodyHeight = ref(0);
    ...
    <div class="market-setup-view">
        <div class="market-setup-body">
            <div class="settings-container">
                ...
                <div class="settings-body" v-if="!next">
                ...
                <div class="settings-body" v-else>
                    ...
                    <ElementSettingContainer>
                        ...
                        <template #setting-content>
                            <ElementMarketSetup :setupObject="setupObject"
                                @update:setupObject="handleUpdateSetupObject" />
                        </template>
                    </ElementSettingContainer> -->
                </div>
            ...
            <div style="width: 100%; display: flex; flex-direction: row; justify-content: space-between;">
                <div>
                    <button v-if="next" class="done-button" @click="handleBack">Back</button>
                </div>
                <div>
                    <button v-if="next" class="done-button" @click="handleDone">Done</button>
